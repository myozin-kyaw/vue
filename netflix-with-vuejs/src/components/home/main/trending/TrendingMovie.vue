    ...
    <div class="row">
      <div class="col-sm-12 overflow-hidden">
        <div class="topten-contents">
          <h4 class="main-title iq-title topten-title">Trending Movies</h4>
          <ul
            id="top-ten-slider"
          ...
          >
            <li class="slick-bg">
              <a href="#">
                <img
                  src="/src/assets/images/top-10/01.jpg"
            ...
            <li class="slick-bg">
              <a href="#">
                <img
                  src="/src/assets/images/top-10/02.jpg"
                  class="img-fluid w-100"
                  alt=""
                />
                <h6 class="iq-title">
            ...
            <li class="slick-bg">
              <a href="#">
                <img
                  src="/src/assets/images/top-10/03.jpg"
                  class="img-fluid w-100"
                  alt=""
                />
            ...
            <li class="slick-bg">
              <a href="#">
                <img
                  src="/src/assets/images/top-10/04.jpg"
                  class="img-fluid w-100"
                  alt=""
                />
            ...
            <li class="slick-bg">
              <a href="#">
                <img
                  src="/src/assets/images/top-10/05.jpg"
                  class="img-fluid w-100"
                  alt=""
                />
            ...
            <li class="slick-bg">
              <a href="#">
                <img
                  src="/src/assets/images/top-10/06.jpg"
                  class="img-fluid w-100"
                  alt=""
                />
